                        ...
                        <Form size="big">
                            ...
                            <Grid.Column>
                                <Grid.Row>
                                    <Segment textAlign="left" size="big">
                                        <Form.Group>
                                            <h3>A. Is the youth applicant a U.S. citizen or qualified alien? </h3>
                                            <Icon name="asterisk" color="red" size="small" corner />
                                            <Form.Radio
                                                name="youthUSCiti"
                                                value="Yes"
                                        ...
                                        <Form.Group>
                                            <h3>C. Does the youth applicant fall into one (1) or more of the three categories below
                          (check the category below that apply to the youth)?:  </h3>
                                            <Icon name="asterisk" color="red" size="small" corner />
                                            <Form.Radio
                                        ...
                                        <Form.Group>
                                            ...
                                            <Form.Radio
                                                ...
                                                checked={values.youth3CateRadio === "Between 6 and 17 years old"}
                                                error={
                            ...
                            school letterhead): OR"
                                                ...
                                                checked={values.youth3CateRadio === "18 years old and enrolled in school"}
                                                error={
                                                    touched.youth3CateRadio &&
                                                    errors.youth3CateRadio !== undefined
                                                }
                                            ...
                                            <Form.Radio
                                                ...
                                                checked={values.youth3CateRadio === "18 to 19 years old, dependent child, AND custodial parent"}
                                                error={
                                                    touched.youth3CateRadio &&
                                                    errors.youth3CateRadio !== undefined
                                                }
