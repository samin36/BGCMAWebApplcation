...
export const paragraph1 = (
    <p style={{ textIndent: "2em" }}>
        Your child’s opinions are important, and we want them to have the best experience at the Club! Our Clubs can only get
        better if we hear from our members. We invite your child to participate in BGCMA’s outcome assessments that focus on
        academic success, healthy lifestyles, character & leadership, and their opinions about this Club. To provide the children of
        this community with the most effective and fun programs requires us to periodically ask members about their life and their
        experiences in the club. The information we gather will be used to help Club staff better understand Club members and
        the programs that will best promote their overall success as students and as successful adults.
    </p>
);
...
export const paragraph4 = (
    <ul>
        <li>
            ...
            or him to participate. You son or daughter must also agree to participate. If you do not give your permission, or if
...
export const paragraph5 = (
    <p style={{ textIndent: "2em" }}>
        All information from the assessments is kept confidential to the full extent allowed by law. The completed electronic
        surveys will remain secured within our membership database accessible only to BGCMA’s Evaluation & Measurement
        Team. No other children or adult staff at this Club or anywhere else will know what answers your child provides. All the
        findings will be combined, summarized and reported in group form so that it will be impossible to identify individual
        people. A summary of the findings will be made available to parents by request.
    </p>
);
...
export const paragraph6 = (
    <Header textAlign="center" as="h1">
        <b>
            Acceptable Use Policy for Members/Bring Your Own Device Policy
        </b>
    </Header>
);
...
export const paragraph7 = (
    <p>
        I, the undersigned legal parent/guardian, will agree to review and will abide by the Bring Your Own Device/Tech
        Acceptable Use Policy and guidelines for the Boys & Girls Clubs of Metro Atlanta. I understand these policies will be
        covered in-depth during the Mandatory Parent Orientation. I can also request a copy from my Club.
    </p>
);